# BatchMonitorUnsubscribe-Example.py
...
# this script will unsubscribe the phone numbers in the file phonenumbers.txt
# so you will no longer receive notifications for changes to these numbers.
# More details are available in the Phone Number Verification section
# of the SDC documentation pages.
# Once complete the output file confirms what events the number was unsubscribed from.
# This can also be checked by going to
# https://developer.syniverse.com/index.html#!/ess/topic-subscriptions
# where you will see a list of all the remaining subscriptions.
...
schedule_job_payload = {"schedule": { "jobId" : "NIS-Unsubscribe-v2", "name" : "NISUnsubscribe", "inputFileId" : file_id,
                                       "fileRetentionDays" : 30, "scheduleRetentionDays" : 30,
                                       "outputFileNamingExpression" : "DS1-NIS-Unsubscribe-output.txt",
